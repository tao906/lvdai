...
def generate_launch_description():
    ...
    show_rviz_arg = DeclareLaunchArgument(
        'show_rviz', 
        default_value='True', 
        description='Set to true to launch RViz automatically'
    )
    ...
    rviz_config_dir = os.path.join(rm_nav_pkg, 'rviz', 'fastlio.rviz')
